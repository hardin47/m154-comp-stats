...
Both functions create vectors.  One with repeated values, the other with a sequence of values.  Try different inputs to the functions to see what you get!
...
sim_k_max <- data.frame(row_id = seq(1, reps, 1)) %>%
  ...
  pivot_wider(id_cols = row_id, names_from = output, values_from = max_for_EX) 
```
]
