...
Some other assignments will be paired assignments.
...
```{r echo = FALSE, fig.cap="Always pull before you start.", fig.alt = "Screen shot of how to pull using the Rstudio IDE."}
...
```{r echo = FALSE, fig.cap="Always pull before you start.", fig.alt = "Screen shot of how to commit using the Rstudio IDE."}
include_graphics("images/commit.png")
```

## `push` your work to GitHub

```{r echo = FALSE, fig.cap="Always pull before you start.", fig.alt = "Screen shot of how to push using the Rstudio IDE."}
