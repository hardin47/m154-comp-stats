...
Each assignment will be provided as a link to GitHub. Click the link.  (The link will come to you via an email from Canvas.  If you lose the email, or the email goes to your spam folder, check Canvas messages for the assignment link.)
