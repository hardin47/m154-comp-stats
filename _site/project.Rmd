...
In addition to the examples you have seen over the course of the semester (and previous project links given at the bottom of this page), here are some generic ideas:
  ...
  * Create a Shiny application that helps a Pomona professor analyze her data  
...
Please respond to the following three questions via email by the end of the day Friday, November 19th.
...
You will need to email me or submit your slides to GitHub before your presentation, but you should also bring the slides on a flash drive as a backup. You should plan to not hook up your laptop to the computer in Millikan 1021 (unless you have good reason and have spoken to me about it beforehand).
...
Your write-up will similar to a report to client crafted in R Markdown, compiled to a pdf, due on Wednesday, December 14th by midnight. 
