...
(@) In $n$ random samples, how many values for $\hat{\theta}$ do you have? How many values for $SE(\hat{\theta})$ do you have?[^70a]
    a. 1, 1
    b. 1, n
    c. n, 1
    d. n, n
...
(@) In $B$ bootstrap re-samples, how many values for $\hat{\theta}^*(b)$ do you have? How many values for $SE^*$ do you have?[^70b]
    a. 1, 1
    b. 1, B
    c. B, 1
    d. B, B
