...
```{r echo = FALSE}
schedule <- tribble(
  ~date, ~topic, ~reading, ~slides, ~example, ~code, ~assignment, ~extra, ~notes,
  "8.31.21", "Introduction to Computational Statistics",
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fas fa-book"></i></a>',
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fas fa-desktop"></i></a>',
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fas fa-lightbulb"></i></a>',
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fas fa-laptop"></i></a>',
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fab fa-github"></i></a>',
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fas fa-sun"></i></a>',
  '<a href="http://st47s.com/Math154/Notes/intro.html"><i class="fas fa-book-open"></i></a>',
  "9.2.21", "",
...
```{r echo = FALSE}
schedule %>% 
  kbl(escape = FALSE, align = c(rep('l',2), rep('c',7))) %>%
