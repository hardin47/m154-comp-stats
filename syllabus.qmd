...
**Mentor Sessions:** 
Sunday 4-6pm in Estella 2099  
Tues 8-10pm in Estella 2141     
Mentor: Tiernan Colby  
...
**Computational Statistics** will be an introduction to those statistical methods that rely heavily on the use of computers. The course will generally have two parts. The first section will include communicating and working with data in a modern era, which includes data wrangling, data visualization, data ethics, and collaborative research (via GitHub). Additionally, we will focus on traditional statistical inference done through computational methods (e.g., simulation, permutation tests, and bootstrapping). The second part of the course will focus on machine learning ideas such as classification, clustering, and dimension reduction techniques. Some of the methods were invented before the ubiquitous use of personal computers, but only because the calculus used to solve the problem was relatively straightforward (or because the method wasn't actually ever used). Some of the methods have been developed quite recently.
...
* If you feel like your performance in the class is being impacted by your experiences outside of class, please don't hesitate to come and talk with me. You can also relay information to me via your mentors.
* I want to be a resource for you. If you prefer to speak with someone outside of the course, the math liaisons, Dean of Students, or QSC staff are all excellent resources.
...
:::note
* Content: **Modern Data Science with R**; Baumer, Kaplan, and Horton, <a href="https://mdsr-book.github.io/mdsr3e/" target="_blank">https://mdsr-book.github.io/mdsr3e/</a>  
* R resource: **R for Data Science**, Wickham, <a href = "https://r4ds.hadley.nz/" target="_blank">https://r4ds.hadley.nz/</a>  
:::

<!--
* Recommended: Visual and Statistical Thinking: Displays of Evidence for Making Decisions; Tufte <a href="http://www.edwardtufte.com/tufte/books_textb" target="_blank">http://www.edwardtufte.com/tufte/books_textb</a> (or find online)
-->

### Second section of the course (bootstrapping, knn, trees, bagging, random forests, support vector machines, clustering)

:::note
* Content: **An Introduction to Statistical Learning with applications in R**; James, Witten, Hastie, and Tibshirani <a href="https://www.statlearning.com/" target="_blank">https://www.statlearning.com/</a>  
...
:::note
* Check-in quizzes on 9.10, 9.24, 10.8, 10.22, 11.12, and 12.3 (in class)
* 10.15.25 Initial Project Proposal due (to Canvas by midnight) 
* 10.29.25 Final Project Proposal due (to GitHub by midnight) 
* 11.12.25 Project Update due (to GitHub by midnight) 
<!--* 12.02.25 (4:15pm) Data Science Panel with industry data scientists-->
* 12.05.25 (Friday) or 12.08.25 (Monday) Group Presentations (both 2-5pm) 
* 12.8.25 Final write-up due (to GitHub by midnight) 
:::
...
Weekly homework will be assigned from the text(s) with some additional problems. One homework grade will be dropped. Homework will be done using the statistical software package R (in the RStudio IDE) and posted to GitHub + Gradescope. All homework must be done in Quarto and compiled to pdf.  
  ...
  * Homework will be due on Wednesdays by 11:59pm to GitHub + Gradescope. 
  * HW should be turned in to your GitHub repository and posted to Gradescope by Wednesday at 11:59pm.
  * Always post both a PDF (.pdf) and a Quarto file (.qmd) to GitHub and to Gradescope, unless otherwise requested.
...
There will be a semester long group project. Your task is to use data to tell us something interesting. This project is deliberately open-ended to allow you to fully explore your creativity. There are three main rules that must be followed: (1) data centered, (2) tell us something, (3) do something new that expands on what you've learned in the course. Project information is available here: [Math 154 Semester Project](/project/)
