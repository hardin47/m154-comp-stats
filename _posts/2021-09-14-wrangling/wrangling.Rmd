...
* How do you distinguish the different `_join` functions?

* Are the `_join` keys formatted in the same way across the two datasets?

* Are the data recorded in the same way (e.g., is age birthday or age at recording?) ?
