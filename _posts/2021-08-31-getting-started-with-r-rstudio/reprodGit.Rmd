...
```{r, out.width = "800px", echo=FALSE}
knitr::include_graphics("../../images/politicalquotes.png") 
```
...
* See course website for getting started: http://research.pomona.edu/johardin/math154f17/

R vs R Studio
=========================

```{r fig.cap = "Taken from [Modern Drive: An introduction to statistical and data sciences via R](https://ismayc.github.io/moderndiver-book/), by Ismay and Kim", fig.width = 10, fig.align='center', echo=FALSE}
...
```{r fig.cap = "[Jessica Ward](https://jkrward.github.io/), PhD student at Newcastle University", fig.width=10, fig.align='center', echo=FALSE}
...
3. Which is better:  high touch (automatic) or low touch (manual) data collection?  Why?
