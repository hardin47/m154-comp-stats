...
description: |
  The sample as a proxy for the unknown population.  Sample from the proxy population (i.e., the sample) to generate a sampling distribution.  Bootstrap.
author:
  - name: Johanna Hardin
...
* <a href = "https://m154-comp-stats.netlify.app/slides/2021-10-05-bootstrap" target = "_blank">In class slides</a> for both 9/28/21 and 9/30/21.
