...
1. R code, examples
2. Conditions, exchangeability, random structure
...
* Why for a two sample comparison is it okay to use $\overline{Y}_A - \overline{Y}_B$ for a test statistic in a permutation test, but for a t-test the test statistic is necessarily $t^* = \frac{\overline{Y}_A - \overline{Y}_B}{\sqrt{s^2_A/n_A + s^2_B/n_B}}$  (that is, divided by a measure of variability)?
...
* <a href = "https://m154-comp-stats.netlify.app/slides/Math154_WU8_HT.pdf" target = "_blank">WU8 - HT logic</a>

* <a href = "https://m154-comp-stats.netlify.app/slides/Math154_WU9_permute.pdf" target = "_blank">WU9 - Permuting</a>
