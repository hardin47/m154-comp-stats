...
* a point is classified to be in the group for which the majority of the $k$ closest points in the training data.
...
Randomly split the training data into V
...
.panel[.panel-name[model]
```{r}
penguin_knn <- nearest_neighbor(neighbors = 9) %>%
  set_engine("kknn") %>%
  set_mode("classification")
