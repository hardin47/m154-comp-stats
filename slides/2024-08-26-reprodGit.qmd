...
Note: before Wednesday, listen to the <a href = "https://nssdeviations.com/71-compromised-shoe-situation" target = "_blank">full conversation</a> of Not So Standard Deviations - Compromised Shoe Situation.


Course structure
=========================
* weekly HW (to GitHub + Gradescope)
* bi-weekly quizzes + data project
