...
```{r out.width='100%', fig.align="center",  echo=FALSE}
#| fig_cap: "Gender bias seen in study on 20,000 students. The students knew the gender of their prof, but did not choose their class. https://doi.org/10.1093/jeea/jvx057"
...
```{r out.width='100%', fig.align="center", echo=FALSE}
#| fig_cap: "86 students assigned randomly to the TA section. *Innovative Higher Education*, **40**, pages 291–303 (2015). https://doi.org/10.58188/1941-8043.1509"
...
#| fig_cap: "Analysis was done using t-tests. https://doi.org/10.58188/1941-8043.1509"
