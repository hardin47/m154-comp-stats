...
Yee and  Chu created a step-by-step build of a recursive binary tree to model the differences between homes in SF and homes in NYC.
...
.panel[.panel-name[k]
```{r}
cart_grid <- expand.grid(cost_complexity = seq(0, 5, by = 0.5),
                        tree_depth = seq(1, 10, by = 0.5))
cart_grid
